...
type LoginRequest struct {
	...
	UserAgent string `protobuf:"bytes,3,opt,name=userAgent,proto3" json:"userAgent,omitempty"` // 用户的设备信息
}
...
type Response struct {
	...
	Token string `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"` // 登录之后返回用户的token
}
...
func (x *PhoneRequest) GetUserAgent() string {
	if x != nil {
		return x.UserAgent
	}
	return ""
...
type LogoutRequest struct {
	...
	Token     string `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"` // 把token传过去方便后台删除redis的相关信息
}
...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x2e, 0x76, 0x31, 0x22, 0x64, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65,
	...
	0x52, 0x09, 0x75, 0x73, 0x65, 0x72, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x22, 0x46, 0x0a, 0x08, 0x52,
	...
	0x0a, 0x0c, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14,
	0x0a, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70,
	0x68, 0x6f, 0x6e, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x41, 0x67, 0x65, 0x6e,
	...
	0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x26, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x64,
	...
	0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x43, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52,
	...
	0x67, 0x65, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x24, 0x0a, 0x0e, 0x4c, 0x6f,
	...
	0x32, 0xff, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x43, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x1d, 0x2e, 0x61, 0x75, 0x74, 0x68,
	...
	,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4b, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x12,
	...
	0x22, 0x00, 0x42, 0x2a, 0x5a, 0x28, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2d, 0x61, 0x75,
	0x74, 0x68, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x06,
...
var file_auth_service_proto_goTypes = []interface{}{
	...
	(*Response)(nil),        // 1: auth.service.v1.Response
	(*RegisterRequest)(nil), // 2: auth.service.v1.RegisterRequest
	(*PhoneRequest)(nil),    // 3: auth.service.v1.PhoneRequest
	(*GetCodeRequest)(nil),  // 4: auth.service.v1.GetCodeRequest
	(*GetCodeResponse)(nil), // 5: auth.service.v1.GetCodeResponse
	(*LogoutRequest)(nil),   // 6: auth.service.v1.LogoutRequest
	(*LogoutResponse)(nil),  // 7: auth.service.v1.LogoutResponse
}
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: auth.service.v1.AuthService.Login:input_type -> auth.service.v1.LoginRequest
	2, // 1: auth.service.v1.AuthService.Register:input_type -> auth.service.v1.RegisterRequest
	3, // 2: auth.service.v1.AuthService.Phone:input_type -> auth.service.v1.PhoneRequest
	4, // 3: auth.service.v1.AuthService.GetCode:input_type -> auth.service.v1.GetCodeRequest
	6, // 4: auth.service.v1.AuthService.Logout:input_type -> auth.service.v1.LogoutRequest
	1, // 5: auth.service.v1.AuthService.Login:output_type -> auth.service.v1.Response
	1, // 6: auth.service.v1.AuthService.Register:output_type -> auth.service.v1.Response
	1, // 7: auth.service.v1.AuthService.Phone:output_type -> auth.service.v1.Response
	5, // 8: auth.service.v1.AuthService.GetCode:output_type -> auth.service.v1.GetCodeResponse
	7, // 9: auth.service.v1.AuthService.Logout:output_type -> auth.service.v1.LogoutResponse
